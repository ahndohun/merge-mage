...
export const SUMMON_COST_GROWTH = 1.22
...
export const SLOT_UPGRADE_COST_GROWTH = 1.9
...
export const MANA_DAMAGE_PER_CRYSTAL = 0.1
export const GOLD_REWARD_BASE = 2
export const GOLD_REWARD_GROWTH = 1.25
