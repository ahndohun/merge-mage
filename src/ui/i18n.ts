...
const enMessages = {
  ...
  inventoryEmptyAutoEquip: "INVENTORY — empty (new books auto-equip)",
  slot: "SLOT",
  up: "UP",
  skillPoints: "SKILL POINTS",
  skillSummonFloor: "MIN BOOK LEVEL",
  ...
  holy: "HOLY",
  elements: "ELEMENTS",
  helpLoopSummon: "BUY a spellbook",
  ...
  tutorialSummon: "Tap BUY to arm your first spellbook",
  tutorialFight: "Your books fight for you. Buy more!",
  tutorialMerge: "Tap one book, then another of the same level to MERGE — works in slots too",
  hintSummonFirst: "Tap BUY to arm your first spellbook",
  ...
  toastSummonLevelUp: "Buy level up — stronger books!",
...
const ko: Record<MessageKey, string> = {
  ...
  tutorialSummon: "구매를 눌러 첫 마법서를 장착해 보세요",
  tutorialFight: "마법서가 대신 싸워요. 더 구매해 보세요!",
  tutorialMerge: "같은 레벨 마법서 두 권을 차례로 탭하면 합성돼요. 슬롯에서도 돼요",
  hintSummonFirst: "구매를 눌러 첫 마법서를 장착해 보세요",
  ...
  toastSummonLevelUp: "구매 레벨 업 — 더 강한 마법서!",
...
const templates: Record<Locale, TemplateSet> = {
  en: {
    ...
    slotAriaLabel: (slotNumber, level, elementName) =>
      level === null || elementName === null ? `Slot ${slotNumber}: empty` : `Slot ${slotNumber}: Lv${level} ${elementName} tome`,
...
const enQuestText: Record<string, { readonly title: string; readonly description: string }> = {
  "chain-01": { title: "Bind the First Tome", description: "Buy or equip any spellbook." },
...
const koQuestText: Record<string, { readonly title: string; readonly description: string }> = {
  "chain-01": { title: "첫 마법서 결속", description: "아무 마법서나 구매하거나 장착하세요." },
