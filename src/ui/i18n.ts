...
const enMessages = {
  appTitle: "MERGE MAGE",
  documentTitle: "Merge Mage — retro idle orb battler",
  loading: "loading...",
  tabBooks: "ORBS",
  tabWizard: "WIZARD",
  tabJourney: "JOURNEY",
  ...
  familiar: "FAMILIAR",
  mineTitle: "MANA MINE",
  skinsTitle: "WIZARD SKINS",
  dailyTitle: "DAILY MISSIONS",
  skinApprentice: "APPRENTICE",
  skinEmber: "EMBER",
  skinFrost: "FROST",
  skinGilded: "GILDED",
  ...
  missionMerge20: "MERGE 20 ORBS",
  missionBoss3: "KILL 3 BOSSES",
  missionSummon30: "BUY 30 ORBS",
  missionMineClaim1: "CLAIM THE MINE",
  missionStage3: "ADVANCE 3 STAGES",
  inventoryEmptyAutoEquip: "INVENTORY — empty (new orbs auto-equip)",
  slot: "SLOT",
  up: "UP",
  skillPoints: "SKILL POINTS",
  skillSummonFloor: "MIN ORB LEVEL",
  ...
  rebirthReset: "RESET: stage, gold, orbs",
  ...
  ranksError: "Couldn't load ranks — tap refresh to try again",
  ...
  holy: "HOLY",
  elements: "ELEMENTS",
  helpLoopSummon: "BUY an orb",
  helpLoopAutoEquip: "orbs AUTO-EQUIP",
  ...
  helpMergeTargetNote: "Merging keeps the element of the TARGET orb (the second one you tap).",
  helpOfflineNote: "You earn gold while away (up to 8h).",
  replayTutorial: "REPLAY TUTORIAL",
  tutorialSummon: "Tap BUY to arm your first orb",
  tutorialFight: "Your orbs fight for you. Buy more!",
  tutorialMerge: "Tap one orb, then another of the same level to MERGE — works in slots too",
  hintSummonFirst: "Tap BUY to arm your first orb",
  hintMergePair: "Tap an orb, then another of the same level — works in slots too",
  hintEquipEmptySlot: "Tap an orb, then an empty slot to equip",
  hintBossHoly: "Boss! Holy orbs deal double damage",
  ...
  toastSummonLevelUp: "Buy level up — stronger orbs!",
...
const ko: Record<MessageKey, string> = {
  appTitle: "MERGE MAGE",
  documentTitle: "Merge Mage - 레트로 방치형 구슬 전투",
  loading: "불러오는 중...",
  tabBooks: "구슬",
  tabWizard: "마법사",
  tabJourney: "여정",
  ...
  missionMerge20: "구슬 20회 합성",
  missionBoss3: "보스 3회 처치",
  missionSummon30: "구슬 30회 구매",
  missionMineClaim1: "광산 1회 수령",
  missionStage3: "스테이지 3회 전진",
  inventoryEmptyAutoEquip: "가방 비어 있음 - 구매하면 자동 장착",
  slot: "슬롯",
  up: "강화",
  skillPoints: "스킬 포인트",
  skillSummonFloor: "구매 최소 레벨",
  ...
  ranksError: "랭킹을 불러오지 못했어요 — 새로고침을 눌러 주세요",
  ...
  holy: "신성",
  elements: "원소",
  helpLoopSummon: "구슬 구매",
  helpLoopAutoEquip: "구슬은 자동 장착돼요",
  ...
  frostDesc: "느리게 해요",
  holyDesc: "보스에게 2배",
  helpMergeTargetNote: "합성하면 두 번째로 탭한 구슬의 원소가 남아요.",
  helpOfflineNote: "접속하지 않아도 최대 8시간까지 골드를 벌어요.",
  replayTutorial: "튜토리얼 다시 보기",
  tutorialSummon: "구매를 눌러 첫 구슬을 장착해 보세요",
  tutorialFight: "구슬이 대신 싸워요. 더 구매해 보세요!",
  tutorialMerge: "같은 레벨 구슬 두 권을 차례로 탭하면 합성돼요. 슬롯에서도 돼요",
  hintSummonFirst: "구매를 눌러 첫 구슬을 장착해 보세요",
  hintMergePair: "같은 레벨 구슬 두 권을 차례로 탭해 합성해요",
  hintEquipEmptySlot: "구슬을 탭하고 빈 슬롯을 탭하면 장착돼요",
  hintBossHoly: "보스! 신성 구슬은 피해가 2배예요",
  ...
  toastSummonLevelUp: "구매 레벨 업 — 더 강한 구슬!",
...
type TemplateSet = {
  ...
  readonly slotAriaLabel: (slotNumber: number, level: number | null, elementName: string | null) => string
  readonly slotUpgradeAriaLabel: (slotNumber: number, cost: string) => string
  ...
  readonly petEvolution: (evolution: number) => string
...
const templates: Record<Locale, TemplateSet> = {
  en: {
    ...
    summonButton: (level, cost) => `BUY Lv${level} · ${cost}G`,
    wizardLevel: (level) => `WIZARD ${level}`,
    levelBadge: (level) => `Lv${level}`,
    slotUpgrade: (cost, bonusPercent) => `UP ${cost} (+${bonusPercent}%)`,
    slotAriaLabel: (slotNumber, level, elementName) =>
      level === null || elementName === null ? `Slot ${slotNumber}: empty` : `Slot ${slotNumber}: Lv${level} ${elementName} orb`,
    slotUpgradeAriaLabel: (slotNumber, cost) => `Upgrade slot ${slotNumber} — ${cost} gold, permanent damage bonus`,
    skillSummonBonusEffect: (points) => `+1 buy level / pt (+${points})`,
    ...
    rebirthPreview: (manaCrystals) => `${manaCrystals} crystals`,
    rebirthGain: (manaCrystals, damagePercentPerCrystal) => `GAIN: +${manaCrystals} crystals (each = +${damagePercentPerCrystal}% damage, forever)`,
    rebirthUnlock: (stage) => `Unlocks at stage 10 (now: ${stage})`,
    relicLevel: (level) => `Lv${level}`,
    relicSummonCost: (cost) => `${cost} crystals`,
  ...
  ko: {
    ...
    summonButton: (level, cost) => `구매 Lv${level} · ${cost}골드`,
    wizardLevel: (level) => `마법사 ${level}`,
    levelBadge: (level) => `Lv${level}`,
    slotUpgrade: (cost, bonusPercent) => `강화 ${cost} (+${bonusPercent}%)`,
    slotAriaLabel: (slotNumber, level, elementName) =>
      level === null || elementName === null ? `슬롯 ${slotNumber}: 비어 있음` : `슬롯 ${slotNumber}: ${elementName} Lv${level}`,
    slotUpgradeAriaLabel: (slotNumber, cost) => `슬롯 ${slotNumber} 강화 — ${cost}골드, 영구 피해 보너스`,
    skillSummonBonusEffect: (points) => `구매 레벨 +1 / 포인트 (현재 +${points})`,
    skillCastSpeedEffect: (reductionMs, nowMs) => `시전 ${(reductionMs / 1000).toFixed(2)}초 단축 / 포인트 (현재 ${(nowMs / 1000).toFixed(2)}초)`,
    skillGoldGainEffect: (gainPercent, currentPercent) => `골드 +${gainPercent}% / 포인트 (현재 +${currentPercent}%)`,
    skillCritChanceEffect: (gainPercent, currentPercent) => `치명타 +${gainPercent}% / 포인트 (현재 ${currentPercent}%)`,
    rebirthPreview: (manaCrystals) => `크리스탈 ${manaCrystals}`,
    rebirthGain: (manaCrystals, damagePercentPerCrystal) => `획득: +${manaCrystals} 크리스탈 (1개당 피해 +${damagePercentPerCrystal}% 영구)`,
    rebirthUnlock: (stage) => `스테이지 10에서 해금 (현재: ${stage})`,
    relicLevel: (level) => `Lv${level}`,
    relicSummonCost: (cost) => `크리스탈 ${cost}`,
...
const enCounterText: Record<string, string> = {
  ...
  summonsTotal: "Orbs bought",
  rebirths: "Rebirths",
  questsClaimed: "Quest claims",
  highestLevelEver: "Highest orb",
  stagesReached: "Stage",
...
const enTraitText: Record<string, { readonly title: string; readonly description: string }> = {
  ...
  elementalCycle: { title: "Elemental Cycle", description: "Resonance awakens with 2 matching orbs." },
  pyroGlyphs: { title: "Pyro Glyphs", description: "Fire orb damage rises by 20%." },
  ...
  quickHands: { title: "Quick Hands", description: "All orb casting is 10% faster." },
...
const koTraitText: Record<string, { readonly title: string; readonly description: string }> = {
  ...
  pyroGlyphs: { title: "화염 문양", description: "화염 구슬 피해가 20% 증가합니다." },
  ...
  quickHands: { title: "재빠른 손", description: "모든 구슬 시전이 10% 빨라집니다." },
...
const enQuestText: Record<string, { readonly title: string; readonly description: string }> = {
  "chain-01": { title: "Bind the First Orb", description: "Buy or equip any orb." },
  "chain-02": { title: "Ink into Power", description: "Merge your first matching pair." },
  "chain-03": { title: "Third Seal", description: "Reach a Lv3 orb." },
  "chain-04": { title: "Circle of Three", description: "Equip three orbs at once." },
  "chain-05": { title: "Apprentice Shelf", description: "Reach a Lv5 orb." },
  ...
  "chain-10": { title: "Tiered Flame", description: "Reach a Lv10 orb." },
  ...
  "chain-15": { title: "Deep Shelf", description: "Reach a Lv20 orb." },
  ...
  "long-level-50": { title: "Oath: Lv50 Orb", description: "Reach a Lv50 orb." },
}

const koQuestText: Record<string, { readonly title: string; readonly description: string }> = {
  "chain-01": { title: "첫 구슬 결속", description: "아무 구슬이나 구매하거나 장착하세요." },
  "chain-02": { title: "잉크를 힘으로", description: "첫 같은 레벨 쌍을 합성하세요." },
  "chain-03": { title: "세 번째 봉인", description: "Lv3 구슬에 도달하세요." },
  "chain-04": { title: "세 권의 원", description: "구슬 세 권을 동시에 장착하세요." },
  "chain-05": { title: "견습 서가", description: "Lv5 구슬에 도달하세요." },
  ...
  "chain-10": { title: "티어의 불꽃", description: "Lv10 구슬에 도달하세요." },
  ...
  "chain-15": { title: "깊은 서가", description: "Lv20 구슬에 도달하세요." },
  ...
  "long-level-50": { title: "맹세: Lv50 구슬", description: "Lv50 구슬에 도달하세요." },
}
